		...
		<div class="contenedor">
			...
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="login">
				...
				<div class="form-group">
					<input type="integer" name="idviaje" class="usuario" hidden value=<?php echo $_GET['id'];?>>
				</div>
				<div class="form-group">
					<input type="text" name="user" class="usuario" hidden value=<?php echo $_GET['user'];?>>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<i class="icono izquierda fa fa-user"></i><input type="integer" name="codigo" class="usuario" placeholder="Codigo de la tarjeta">
				</div>
				<div class="form-group">
					<input type="integer" name="precio" class="usuario" hidden value=<?php echo $_GET['precio']; ?>>
				</div>
				<div class="form-group">
